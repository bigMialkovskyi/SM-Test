      ...
      function () {
        return (function (g, h, i, j) {
          ...
          (function () {
            ...
            a.coerce;
            a = a.Typed;
            a = a.objectWithFields({ forkedPixelIds: a.arrayOf(a.string()) });
            k.exports = a;
          })();
          return k.exports;
        })(a, b, c, d);
      ...
      return (function (g, h, i, j) {
        ...
        (function () {
          ...
          function x(a, b) {
            ...
            return (
              b === "tel" ||
              u({ id: d, keywords: o.PHONE_NUMBER, name: c, placeholder: a })
            );
          }
          function y(a) {
            var b = a.name,
      ...
      return (function (a, b, c, d) {
        ...
        (function () {
          ...
          var B = w.fired,
            ...
            S;
          b.referrer;
          var T = { PageView: new x(), PixelInitialized: new x() },
            U = new r(f, R),
            V = new ca(U, I),
            W = new x(["eid"]);
          function X(a) {
            ...
            switch (a) {
              ...
              case "firstPartyCookies":
                ...
                typeof p === "string"
                  ...
                  : p === void 0
                  ? (U.disableFirstPartyCookies = r === "optOut")
                  : H({
                      invalidParamName: "pixel_id",
                      invalidParamValue: p,
                      method: "set",
              ...
              case "iwlExtractors":
                var v = c[0],
                  ba = c[1];
                ma.triggerWeakly({ extractors: ba, pixelID: v });
                break;
              case "estRules":
                var ca = c[0],
                  da = c[1];
                na.triggerWeakly({ rules: da, pixelID: ca });
                break;
              case "ccRules":
                var w = c[0],
                  x = c[1];
                oa.triggerWeakly({ rules: x, pixelID: w });
                break;
              case "startIWLBootstrap":
                var y = c[0],
                  z = c[1];
                la.triggerWeakly({ graphToken: y, pixelID: z });
                break;
              case "parallelfire":
                var ka = c[0],
                  A = c[1];
                U.pluginConfig.set(ka, "parallelfire", { target: A });
                break;
              case "openbridge":
                var B = c[0],
                  C = c[1];
                B !== null &&
                  ...
                  typeof B === "string" &&
                  typeof C === "string" &&
                  (U.callMethod(["optIn", B, "OpenBridge"]),
                  U.pluginConfig.set(B, "openbridge", {
              ...
              case "trackSingleOnly":
                ...
                I.error && H(I.error);
                I.warnings &&
                  I.warnings.forEach(function (a) {
                    H(a);
                  });
                M.call(R, G)
                  ? (R[G].trackSingleOnly = F)
                  : H({
                      metadataValue: a,
                      pixelID: G,
              ...
              case "userData":
                ...
                break;
              default:
                var T = U.pluginConfig.getWithGlobalFallback(
                    null,
                    "dataProcessingOptions"
                  ),
          ...
          function Z(a, b, c) {
            ...
            if (M.call(R, d)) {
              b != null && z(R[d].userData)
                ? ((R[d].userData = e ? b || {} : {}), V.loadPlugin("identity"))
          ...
          function ta(a, b, c) {
            for (var d = 0, e = Q.length; d < e; d++) {
              ...
              xa({ customData: b, eventData: c, eventName: a, pixel: f });
              Object.prototype.hasOwnProperty.call(T, a) && T[a].add(f.id);
            }
          }
          function ua(a, b) {
            xa({ customData: b, eventName: a, pixel: null });
          }
          function va(a, b, c) {
            Q.forEach(function (c) {
              return xa({ customData: b, eventName: a, pixel: c });
            });
          }
          function $(a) {
          ...
          function wa(a, b, c, d, e) {
            ...
            g.append("coo", n);
            h = U.pluginConfig.getWithGlobalFallback(
              a ? a.id : null,
              "dataProcessingOptions"
            );
            if (h != null) {
          ...
          ((O && P) || a.fbq !== a._fbq) && H({ type: "CONFLICTING_VERSIONS" });
          Q.length > 1 && H({ type: "MULTIPLE_PIXELS" });
          function za() {
            ...
            var b = v(function () {
              ...
              N = c.href;
              if (N === S) return;
              var a = new X({ allowDuplicatePageViews: !0 });
          ...
          function Aa() {
            "onpageshow" in a &&
              a.addEventListener("pageshow", function (a) {
                if (a.persisted) {
                  a = new X({ allowDuplicatePageViews: !0 });
                  Y.call(a, "trackCustom", "PageView");
                }
              });
          }
          ...
          function Ca() {
            return { pixelInitializationTime: J, pixels: Q };
          }
          function Da(a) {
            (a.instance = U),
              (a.callMethod = Y),
