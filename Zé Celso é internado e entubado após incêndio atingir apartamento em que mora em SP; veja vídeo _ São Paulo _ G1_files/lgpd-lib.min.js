var LGPD = (function (e) {
  ...
  function (e, t, n) {
    ...
    const o = { CookieBanner: n(1).default };
    t.default = o;
  },
  function (e, t, n) {
    "use strict";
    ...
    t.default = class {
      constructor(e = {}) {
        (this.domainName = ""),
          ...
          (this.options = a.Options.merge(e)),
          (this.animator = new r.default(this.options.animation)),
          (this.dom = new i.default({ ...this.options })),
          (this.datetimeOnInit = new Date()),
          (this.domainName = this.chooseDomainName(window.location.hostname)),
          (this.consentService = new s.default(
            this.domainName,
            this.options.localstorage
          )),
          this.start(),
          (this.analytics = new o.default(
            this.environment,
            this.options.tenant
          ));
      }
      start() {
        this.consentService.saveInitialCookies(),
          this.setEnvironment(),
          setTimeout(() => {
            this.consentService.isNotExistsEuropeanBanner() &&
              this.consentService.isNotAcepptUE() &&
              (this.toggleCookieBanner(), this.setAllListeners());
          }, 5e3);
      }
      setEnvironment() {
        this.domainName.includes(".globoi.com")
          ? (this.environment = "qa")
          : ["localhost", "127.0.0.1"].includes(this.domainName)
          ? (this.environment = "dev")
          : (this.environment = "prod");
      }
      show(e) {
        e.setAttribute("class", "cookie-banner-lgpd-visible"),
          this.animator.animateIn(e),
          e.setAttribute("style", "display:flex"),
          this.options.lifecycle.onCookieBannerShow &&
            this.options.lifecycle.onCookieBannerShow(e);
      }
      async hide(e) {
        e.setAttribute("class", "cookie-banner-lgpd-hidden"),
          await this.animator.animateOut(e),
          e.setAttribute("style", "display:none"),
          this.options.lifecycle.onCookieBannerHide &&
            this.options.lifecycle.onCookieBannerHide(e);
      }
      chooseDomainName(e) {
        let t = "";
        return (
          [".globoi.com", ".globo.com", "localhost", "127.0.0.1"].forEach(
            (n) => {
              e.includes(n) && (t = n);
            }
          ),
      ...
      toggleCookieBanner() {
        ...
        !this.consentService.isConsentAccepted() ||
        this.consentService.isAcceptedConsentVersionBefore()
          ? this.show(e)
          : this.hide(e);
      }
      ...
      onButtonClick(e) {
        this.options.lifecycle.onConsentAccepted &&
          this.options.lifecycle.onConsentAccepted(e);
        const t = {
          eventCategory: "lgpd-analytics",
          eventAction: "click",
          eventLabel: "prosseguir",
          eventValue: new Date().valueOf() - this.datetimeOnInit.valueOf(),
        };
        this.analytics.sendCommonEvent(t),
          e.defaultPrevented ||
            (this.consentService.acceptConsent(), this.toggleCookieBanner());
      }
      onPrivacyLinkClick() {
        this.analytics.sendCommonEvent({
          eventCategory: "lgpd-analytics",
          eventAction: "link",
          eventLabel: "Política de Privacidade",
        });
      }
      onPrivacyPortalLinkClick() {
        this.analytics.sendCommonEvent({
          eventCategory: "lgpd-analytics",
          eventAction: "link",
          eventLabel: "Portal da Privacidade",
        });
      }
      setAllListeners() {
        this.setClickListener(
          "cookie-banner-lgpd_privacy-link",
          ...
          this.setClickListener(
            "cookie-banner-lgpd_privacy-portal-link",
            this.onPrivacyPortalLinkClick
          );
      }
    };
  },
    ...
    t.default = class {
      ...
      init() {
        ...
        window.cdaaas &&
          ...
          (e = window.cdaaas.SETTINGS.SITE_ID),
          (this.tenant = this.tenant || e),
          this.tenant &&
            ("prod" != this.environment && o.Settings.useQAConfiguration(),
            (this.client = new o.HorizonClient(this.tenant, "desktop")));
      }
      sendCommonEvent(e) {
        if (this.client)
          try {
      ...
      (e.exports = (function (e) {
              ...
              if (!t.instance) {
                var n =
                    ...
                    u.default.HORIZON_TRACK_HOST +
                      "/" +
                      u.default.HORIZON_TRACK_IDENTIFICATION_RESOURCE,
                  o = !1 === u.default.AVOID_COOKIE_USAGE;
                t.instance = new g(n, o);
              }
              return t.instance;
            };
          t.default = {
            ...
            setLoggedUser: function (e, t) {
              if (!u.default.AVOID_COOKIE_USAGE)
              ...
              function e() {
                ...
                if (
                  ...
                  (this.tenant =
                    t ||
                    c.default.getTenant() ||
                    a.default.mustBeDefined("tenant")),
                  (this.deviceGroup =
                    n ||
                    c.default.getDeviceGroup() ||
                    a.default.mustBeDefined("deviceGroup")),
                ...
                (this.environment = f),
                  ...
                  (this.clientVersion = r.default.PACKAGE_VERSION),
                  (this.state = h),
              ...
              return (
                o(e, [
                  ...
                  },
                  {
                    key: "send",
                    value: function (e) {
                      this.validator.validateArgs(e),
                        this.sendWithInfo(e, this.getScopeInfo());
                    },
                  },
                  {
                    key: "sendWithInfo",
        ...
        function (e, t, n) {
          ...
          t.default = {
            ...
            onReady: function (e) {
              if (l()) return e();
              if (u.ready.length > a.default.HORIZON_CALLBACK_STACK_LIMIT)
                throw new Error(
                    ...
                    value: function (e) {
                      var t =
                        ...
                        s =
                          "" +
                          n +
                          u.default.applyDestinationPolicy() +
                          "/event/" +
                          this.currentTenant +
                          r,
                        c = i.default.get(t);
                  ...
                  for (
                    ...
                    try {
                      ...
                      if (
                        ((p = n.read
                          ? n.read(p, v)
                          : n(p, v) || p.replace(d, decodeURIComponent)),
                        this.json)
                      )
                        try {
                          p = JSON.parse(p);
  ...
  function (e, t, n) {
    ...
    t.default = class {
      ...
      animateIn(e) {
        this.bannerAnimations.animated &&
          (this.setElementAnimated(e),
          this.bannerAnimations.animationIn &&
            this.bannerAnimations.animationIn(e));
      }
      animateOut(e) {
        ...
        return new Promise((t) => {
          [
            ...
            e.addEventListener(n, () => {
              this.bannerAnimations.animationOut &&
                this.bannerAnimations.animationOut(e, n),
                t(n);
            });
          });
        });
  ...
  function (e, t, n) {
    ...
    t.default = class {
      ...
      getBannerRoot() {
        ...
        return (
          e.setAttribute("id", "cookie-banner-lgpd"),
          e.setAttribute("class", "cookie-banner-lgpd-hidden"),
          e.setAttribute("style", "display:none"),
          e
        );
      ...
      getBannerTextBox() {
        const e = document.createElement("div");
        return e.setAttribute("class", "cookie-banner-lgpd_text-box"), e;
      }
      getBannerText() {
        ...
        return (
          ...
          (e.innerText =
            "Nós usamos cookies e outras tecnologias semelhantes para melhorar a sua experiência em nossos serviços, personalizar publicidade e recomendar conteúdo de seu interesse. Ao utilizar nossos serviços, você está ciente dessa funcionalidade. Conheça nosso "),
          e
        );
      }
      getBannerPrivacyLink() {
        ...
        return (
          e.setAttribute(
            "class",
            "cookie-banner-lgpd-link cookie-banner-lgpd_privacy-link"
          ),
          e.setAttribute("target", "_blank"),
          e.setAttribute("style", this.generateLinkStyle()),
          e.setAttribute(
            "href",
            this.domOptions.customPrivacyLinkUrl ||
              "https://privacidade.globo.com/privacy-policy/"
          ),
          (e.innerText = "Política de Privacidade."),
          e
        );
      }
      getBannerPrivacyPortalLink() {
        ...
        return (
          e.setAttribute(
            "class",
            "cookie-banner-lgpd-link cookie-banner-lgpd_privacy-portal-link"
          ),
          e.setAttribute("target", "_blank"),
          e.setAttribute("style", this.generateLinkStyle()),
          e.setAttribute(
            "href",
            this.domOptions.customPrivacyPortalLinkUrl ||
              "https://privacidade.globo.com/"
          ),
          (e.innerText = "Portal da Privacidade"),
          e
        );
      }
      getMiddleBannerText() {
        const e = document.createElement("span");
        return (e.innerText = " e consulte nossa "), e;
      }
      getBannerButtonBox() {
        const e = document.createElement("div");
        return e.setAttribute("class", "cookie-banner-lgpd_button-box"), e;
      }
      getBannerButton() {
        const e = document.createElement("button");
        return (
          e.setAttribute("class", "cookie-banner-lgpd_accept-button"),
          e.setAttribute("style", this.generateButtonStyle()),
          (e.innerText = "Prosseguir"),
          e
        );
      }
      createCookieBanner() {
      ...
      generateLinkStyle() {
        return (
          "" +
          (this.domOptions.style.linkColor
            ? "color:" + this.domOptions.style.linkColor
            : "")
        );
      }
      generateButtonStyle() {
        return (
          "" +
          (this.domOptions.style.buttonColor
            ? "background-color:" + this.domOptions.style.buttonColor
            : "")
        );
      }
    ...
    //     [
    //       {
    //         isValid: () => e && "cookie-banner-lgpd" === e.id,
    //         errorMessage:
    //           "DOM root do cookie banner não pode ser nulo ou undefined e deve conter o id cookie-banner-lgpd",
    //       },
    //       {
    //         isValid() {
    //           const t = e.querySelector(".cookie-banner-lgpd_accept-button");
    //           return t && t.innerHTML.includes("Prosseguir");
    //         },
    //         errorMessage:
    //           "DOM do cookie banner precisa conter um botão com a classe .cookie-banner-lgpd_accept-button e com o texto Prosseguir",
    //       },
    //       {
    //         isValid() {
    ...
    //               "Nós usamos cookies e outras tecnologias semelhantes para melhorar a sua experiência em nossos serviços, personalizar publicidade e recomendar conteúdo de seu interesse. Ao utilizar nossos serviços, você está ciente dessa funcionalidade. Conheça nosso"
    //             ) &&
    //             t.innerText.includes("Política de Privacidade") &&
    //             t.innerText.includes("e consulte nossa")
    //           );
    //         },
    //         errorMessage:
    //           "DOM do cookie banner precisa conter o texto com a classe .cookie-banner-lgpd_text e o conteúdo: Nós usamos cookies e outras tecnologias semelhantes para melhorar a sua experiência em nossos serviços, personalizar publicidade e recomendar conteúdo de seu interesse. Ao utilizar nossos serviços, você está ciente dessa funcionalidade. Conheça nosso Política de Privacidade e consulte nossa",
    //       },
    //       {
    //         isValid() {
    //           const t = e
    //             .querySelector(".cookie-banner-lgpd_text")
    //             .querySelector(".cookie-banner-lgpd_privacy-link");
    //           return Boolean(t);
    //         },
    //         errorMessage:
    //           "DOM de texto do cookie banner precisa conter o link para a política de privacidade",
    //       },
    //     ].forEach((e) => {
      ...
      injectCookieInPage() {
        ...
        return (
          (e = this.domOptions.lifecycle.createCookieBanner
            ? this.domOptions.lifecycle.createCookieBanner({
                cookieBannerRoot: this.getBannerRoot(),
                cookieBannerText: this.assembleBannerText(),
                cookieBannerButton: this.getBannerButton(),
              })
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.bannerDefaultOptions = {
        style: { buttonColor: "#0069de", linkColor: "#0069de" },
        animation: { animationIn: void 0, animationOut: void 0, animated: !0 },
        lifecycle: {
          onCookieBannerShow: void 0,
          onCookieBannerHide: void 0,
          onConsentAccepted: void 0,
          createCookieBanner: void 0,
        },
    ...
    class o {
      static merge(e = {}) {
        return {
          ...
          customPrivacyLinkUrl:
            e.customPrivacyLinkUrl ||
            t.bannerDefaultOptions.customPrivacyLinkUrl,
          customPrivacyPortalLinkUrl:
            e.customPrivacyPortalLinkUrl ||
            t.bannerDefaultOptions.customPrivacyPortalLinkUrl,
    ...
    (t.Options = o),
      (t.default = {
        bannerDefaultOptions: t.bannerDefaultOptions,
        Options: o,
      });
  },
  function (e, t, n) {
    ...
    t.default = class {
      constructor(e, t) {
        (this.isLocalstorage = t),
          (this.store = t ? new i.default() : new o.default(e)),
          (this.consentVersioning = new r.default(this.store));
      }
      acceptConsent() {
        this.store.setItem("cookie-banner-consent-accepted", "true"),
          this.saveVersion();
      }
      saveInitialCookies() {
        if (this.isLocalstorage) return;
        const e = this.store.getItemsByName("cookie-banner-consent-accepted"),
          t = String(e.some((e) => e && e.includes("true")));
        e.length > 1 &&
          [".globo.com", ".globoi.com", ""].forEach((e) => {
            new o.default(e).removeItem("cookie-banner-consent-accepted");
          }),
          1 != e.length &&
            this.store.setItem("cookie-banner-consent-accepted", t);
      }
      saveVersion() {
        this.consentVersioning.saveVersion();
      }
      isAcceptedConsentVersionBefore() {
        return this.consentVersioning.isAcceptedCookieVersionBefore();
      }
      isConsentAccepted() {
        return this.store
          .getItemsByName("cookie-banner-consent-accepted")
          .some((e) => e && e.includes("true"));
      }
      isNotExistsEuropeanBanner() {
        const e = document.getElementsByClassName("fc-dialog-overlay");
        return 0 === Object.values(e).length;
      }
      isNotAcepptUE() {
        return 0 == this.store.getItemsByName("FCCDCF").length;
      }
    };
  },
  function (e, t, n) {
      ...
      setItem(e, t) {
        ...
        const o =
          this.domainName && "" !== this.domainName
            ...
            : "";
        document.cookie = `${e}=${t};${o}path=/;expires=${n.toUTCString()}; SameSite=None; Secure`;
      }
      removeItem(e) {
        const t =
          this.domainName && "" !== this.domainName
            ? `domain=${this.domainName};`
            : "";
        document.cookie = `${e}='';${t}path=/;expires=Thu, 01 Jan 1970 00:00:00 GMT; SameSite=None; Secure`;
      }
    };
  },
  function (e, t, n) {
    ...
    t.default = class {
      ...
      saveVersion() {
        this.store.setItem("cookie-banner-accepted-version", "1.4.2.2");
      }
      isAcceptedCookieVersionBefore() {
        const [e] = this.store.getItemsByName("cookie-banner-accepted-version");
        return (
          this.getLastVersionDigit(e) < this.getLastVersionDigit("1.4.2.2")
        );
      }
    ...
    t.default = class {
      getItemsByName(e) {
        const t = localStorage.getItem(e),
          n = JSON.parse(t),
          o = this.cleanExpired(n, e);
        return [n && !o ? n.value : null];
      }
      setItem(e, t) {
        const n = { value: t, expiration: new Date().getTime() + 31104e6 };
      ...
      cleanExpired(e, t) {
        const n = new Date();
        return (
          !!(e && e.expiration && n.getTime() > e.expiration) &&
          (this.removeItem(t), !0)
        );
      }
    };
